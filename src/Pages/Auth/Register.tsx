  ...
  return (
    <Layout>
      <div className='title_container_reg'>
        ...
        <p className='text'>Register here to participate in our auctions and get your own My Leu account.</p>    
      </div>
      <div className='body'>
        <Formik
        ...
        >
          <Form ref={form} className='form'>
            ...
            <div className='login_dev'>
              <Field className="Feild" name="name" type="text" placeholder="Name" />
            </div>

            <div className='login_dev'>
              <Field className="Feild" name="email" type="email" placeholder="Email" />
            </div>


            <div className='login_dev'>
              <Field className="Feild"  name="phone" type="text" placeholder="phone" />
            </div>

            <div className='login_dev'>
              <Field className="Feild" name="password" type="password" placeholder="Password" />
            </div>
